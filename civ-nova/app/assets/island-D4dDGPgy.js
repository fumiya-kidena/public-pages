...
void main() {
	...
	#include <fog_fragment>
		...
		`,blending:0,depthTest:!1,depthWrite:!1})}function no(e,t,n){let r=new Float32Array(Ha),i=new G(0,1,0);return new _i({name:`SphericalGaussianBlur`,defines:{n:Ha,CUBEUV_TEXEL_WIDTH:1/t,CUBEUV_TEXEL_HEIGHT:1/n,CUBEUV_MAX_MIP:`${e}.0`},uniforms:{envMap:{value:null},samples:{value:1},weights:{value:r},latitudinal:{value:!1},dTheta:{value:0},mipInt:{value:0},poleAxis:{value:i}},vertexShader:ao(),fragmentShader:`
		...
		`,blending:0,depthTest:!1,depthWrite:!1})}function ro(){return new _i({name:`EquirectangularToCubeUV`,uniforms:{envMap:{value:null}},vertexShader:ao(),fragmentShader:`
		...
		`,blending:0,depthTest:!1,depthWrite:!1})}function io(){return new _i({name:`CubemapToCubeUV`,uniforms:{envMap:{value:null},flipEnvMap:{value:-1}},vertexShader:ao(),fragmentShader:`
	...
	`}var oo=class extends Lt{constructor(e=1,t={}){super(e,e,t),this.isWebGLCubeRenderTarget=!0;let n={width:e,height:e,depth:1},r=[n,n,n,n,n,n];this.texture=new ii(r),this._setTextureOptions(t),this.texture.isRenderTargetTexture=!0}fromEquirectangularTexture(e,t){this.texture.type=t.type,this.texture.colorSpace=t.colorSpace,this.texture.generateMipmaps=t.generateMipmaps,this.texture.minFilter=t.minFilter,this.texture.magFilter=t.magFilter;let n={uniforms:{tEquirect:{value:null}},vertexShader:`
...
`;continue}if((u=l.match(i))&&(c.gamma=parseFloat(u[1])),(u=l.match(a))&&(c.exposure=parseFloat(u[1])),(u=l.match(o))&&(c.valid|=2,c.format=u[1]),(u=l.match(s))&&(c.valid|=4,c.height=parseInt(u[1],10),c.width=parseInt(u[2],10)),c.valid&2&&c.valid&4)break}return c.valid&2||t(3,`missing format specifier`),c.valid&4||t(3,`missing image size specifier`),c},i=function(e,n,r){let i=n;if(i<8||i>32767||e[0]!==2||e[1]!==2||e[2]&128)return new Uint8Array(e);i!==(e[2]<<8|e[3])&&t(3,`wrong scanline width`);let a=new Uint8Array(4*n*r);a.length||t(4,`unable to allocate buffer space`);let o=0,s=0,c=4*i,l=new Uint8Array(4),u=new Uint8Array(c),d=r;for(;d>0&&s<e.byteLength;){s+4>e.byteLength&&t(1),l[0]=e[s++],l[1]=e[s++],l[2]=e[s++],l[3]=e[s++],(l[0]!=2||l[1]!=2||(l[2]<<8|l[3])!=i)&&t(3,`bad rgbe scanline format`);let n=0,r;for(;n<c&&s<e.byteLength;){r=e[s++];let i=r>128;if(i&&(r-=128),(r===0||n+r>c)&&t(3,`bad scanline data`),i){let t=e[s++];for(let e=0;e<r;e++)u[n++]=t}else u.set(e.subarray(s,s+r),n),n+=r,s+=r}let f=i;for(let e=0;e<f;e++){let t=0;a[o]=u[e+t],t+=i,a[o+1]=u[e+t],t+=i,a[o+2]=u[e+t],t+=i,a[o+3]=u[e+t],o+=4}d--}return a},a=function(e,t,n,r){let i=2**(e[t+3]-128)/255;n[r+0]=e[t+0]*i,n[r+1]=e[t+1]*i,n[r+2]=e[t+2]*i,n[r+3]=1},o=function(e,t,n,r){let i=2**(e[t+3]-128)/255;n[r+0]=ir.toHalfFloat(Math.min(e[t+0]*i,65504)),n[r+1]=ir.toHalfFloat(Math.min(e[t+1]*i,65504)),n[r+2]=ir.toHalfFloat(Math.min(e[t+2]*i,65504)),n[r+3]=ir.toHalfFloat(1)},s=new Uint8Array(e);s.pos=0;let c=r(s),l=c.width,u=c.height,d=i(s.subarray(s.pos),l,u),f,p,m;switch(this.type){case E:m=d.length/4;let e=new Float32Array(m*4);for(let t=0;t<m;t++)a(d,t*4,e,t*4);f=e,p=E;break;case D:m=d.length/4;let t=new Uint16Array(m*4);for(let e=0;e<m;e++)o(d,e*4,t,e*4);f=t,p=D;break;default:throw Error(`THREE.HDRLoader: Unsupported type: `+this.type)}return{width:l,height:u,data:f,header:c.string,gamma:c.gamma,exposure:c.exposure,type:p}}setDataType(e){return this.type=e,this}load(e,t,n,r){function i(e,n){switch(e.type){case E:case D:e.colorSpace=qe,e.minFilter=_,e.magFilter=_,e.generateMipmaps=!1,e.flipY=!0;break}t&&t(e,n)}return super.load(e,i,n,r)}},Kc=class extends Gc{constructor(e){console.warn(`RGBELoader has been deprecated. Please use HDRLoader instead.`),super(e)}},qc=(()=>{let e=new Float32Array([-1,-1,0,3,-1,0,-1,3,0]),t=new Float32Array([0,0,2,0,0,2]),n=new Cr;return n.setAttribute(`position`,new cr(e,3)),n.setAttribute(`uv`,new cr(t,2)),n})(),Jc=class e{static get fullscreenGeometry(){return qc}constructor(e=`Pass`,t=new wn,n=new ca){this.name=e,this.renderer=null,this.scene=t,this.camera=n,this.screen=null,this.rtt=!0,this.needsSwap=!0,this.needsDepthBlit=!1,this.needsDepthTexture=!1,this.enabled=!0}get renderToScreen(){return!this.rtt}set renderToScreen(e){if(this.rtt===e){let t=this.fullscreenMaterial;t!==null&&(t.needsUpdate=!0),this.rtt=!e}}set mainScene(e){}set mainCamera(e){}setRenderer(e){this.renderer=e}isEnabled(){return this.enabled}setEnabled(e){this.enabled=e}get fullscreenMaterial(){return this.screen===null?null:this.screen.material}set fullscreenMaterial(t){let n=this.screen;n===null?(n=new Kr(e.fullscreenGeometry,t),n.frustumCulled=!1,this.scene===null&&(this.scene=new wn),this.scene.add(n),this.screen=n):n.material=t}getFullscreenMaterial(){return this.fullscreenMaterial}setFullscreenMaterial(e){this.fullscreenMaterial=e}getDepthTexture(){return null}setDepthTexture(e,t=Ge){}render(e,t,n,r,i){throw Error(`Render method not implemented!`)}setSize(e,t){}initialize(e,t,n){}dispose(){for(let t of Object.keys(this)){let n=this[t];(n instanceof Lt||n instanceof Tr||n instanceof Pt||n instanceof e)&&this[t].dispose()}this.fullscreenMaterial!==null&&this.fullscreenMaterial.dispose()}},Yc=class extends Jc{constructor(){super(`ClearMaskPass`,null,null),this.needsSwap=!1}render(e,t,n,r,i){let a=e.state.buffers.stencil;a.setLocked(!1),a.setTest(!1)}},Xc=`#ifdef COLOR_WRITE
#include <common>
#include <dithering_pars_fragment>
...
#include <colorspace_fragment>
}`,vl=`uniform vec4 texelSize;uniform float kernel;uniform float scale;varying vec2 vUv0;varying vec2 vUv1;varying vec2 vUv2;varying vec2 vUv3;void main(){vec2 uv=position.xy*0.5+0.5;vec2 dUv=(texelSize.xy*vec2(kernel)+texelSize.zw)*scale;vUv0=vec2(uv.x-dUv.x,uv.y+dUv.y);vUv1=vec2(uv.x+dUv.x,uv.y+dUv.y);vUv2=vec2(uv.x+dUv.x,uv.y-dUv.y);vUv3=vec2(uv.x-dUv.x,uv.y-dUv.y);gl_Position=vec4(position.xy,1.0,1.0);}`,yl=[new Float32Array([0,0]),new Float32Array([0,1,1]),new Float32Array([0,1,1,2]),new Float32Array([0,1,2,2,3]),new Float32Array([0,1,2,3,4,4,5]),new Float32Array([0,1,2,3,4,5,7,8,9,10])],bl=class extends _i{constructor(e=new Ft){super({name:`KawaseBlurMaterial`,uniforms:{inputBuffer:new Y(null),texelSize:new Y(new Ft),scale:new Y(1),kernel:new Y(0)},blending:0,toneMapped:!1,depthWrite:!1,depthTest:!1,fragmentShader:_l,vertexShader:vl}),this.setTexelSize(e.x,e.y),this.kernelSize=gl.MEDIUM}set inputBuffer(e){this.uniforms.inputBuffer.value=e}setInputBuffer(e){this.inputBuffer=e}get kernelSequence(){return yl[this.kernelSize]}get scale(){return this.uniforms.scale.value}set scale(e){this.uniforms.scale.value=e}getScale(){return this.uniforms.scale.value}setScale(e){this.uniforms.scale.value=e}getKernel(){return null}get kernel(){return this.uniforms.kernel.value}set kernel(e){this.uniforms.kernel.value=e}setKernel(e){this.kernel=e}setTexelSize(e,t){this.uniforms.texelSize.value.set(e,t,e*.5,t*.5)}setSize(e,t){let n=1/e,r=1/t;this.uniforms.texelSize.value.set(n,r,n*.5,r*.5)}},xl=class extends Jc{constructor({kernelSize:e=gl.MEDIUM,resolutionScale:t=.5,width:n=fl.AUTO_SIZE,height:r=fl.AUTO_SIZE,resolutionX:i=n,resolutionY:a=r}={}){super(`KawaseBlurPass`),this.renderTargetA=new Lt(1,1,{depthBuffer:!1}),this.renderTargetA.texture.name=`Blur.Target.A`,this.renderTargetB=this.renderTargetA.clone(),this.renderTargetB.texture.name=`Blur.Target.B`;let o=this.resolution=new fl(this,i,a,t);o.addEventListener(`change`,e=>this.setSize(o.baseWidth,o.baseHeight)),this._blurMaterial=new bl,this._blurMaterial.kernelSize=e,this.copyMaterial=new Qc}getResolution(){return this.resolution}get blurMaterial(){return this._blurMaterial}set blurMaterial(e){this._blurMaterial=e}get dithering(){return this.copyMaterial.dithering}set dithering(e){this.copyMaterial.dithering=e}get kernelSize(){return this.blurMaterial.kernelSize}set kernelSize(e){this.blurMaterial.kernelSize=e}get width(){return this.resolution.width}set width(e){this.resolution.preferredWidth=e}get height(){return this.resolution.height}set height(e){this.resolution.preferredHeight=e}get scale(){return this.blurMaterial.scale}set scale(e){this.blurMaterial.scale=e}getScale(){return this.blurMaterial.scale}setScale(e){this.blurMaterial.scale=e}getKernelSize(){return this.kernelSize}setKernelSize(e){this.kernelSize=e}getResolutionScale(){return this.resolution.scale}setResolutionScale(e){this.resolution.scale=e}render(e,t,n,r,i){let a=this.scene,o=this.camera,s=this.renderTargetA,c=this.renderTargetB,l=this.blurMaterial,u=l.kernelSequence,d=t;this.fullscreenMaterial=l;for(let t=0,n=u.length;t<n;++t){let n=t&1?c:s;l.kernel=u[t],l.inputBuffer=d.texture,e.setRenderTarget(n),e.render(a,o),d=n}this.fullscreenMaterial=this.copyMaterial,this.copyMaterial.inputBuffer=d.texture,e.setRenderTarget(this.renderToScreen?null:n),e.render(a,o)}setSize(e,t){let n=this.resolution;n.setBaseSize(e,t);let r=n.width,i=n.height;this.renderTargetA.setSize(r,i),this.renderTargetB.setSize(r,i),this.blurMaterial.setSize(e,t)}initialize(e,t,n){n!==void 0&&(this.renderTargetA.texture.type=n,this.renderTargetB.texture.type=n,n===1009?e!==null&&e.outputColorSpace===`srgb`&&(this.renderTargetA.texture.colorSpace=Ke,this.renderTargetB.texture.colorSpace=Ke):(this.blurMaterial.defines.FRAMEBUFFER_PRECISION_HIGH=`1`,this.copyMaterial.defines.FRAMEBUFFER_PRECISION_HIGH=`1`))}static get AUTO_SIZE(){return fl.AUTO_SIZE}},Sl=`#include <common>
#ifdef FRAMEBUFFER_PRECISION_HIGH
uniform mediump sampler2D inputBuffer;
#else
uniform lowp sampler2D inputBuffer;
...
#endif
}`,Cl=class extends _i{constructor(e=!1,t=null){super({name:`LuminanceMaterial`,defines:{THREE_REVISION:`183`.replace(/\D+/g,``)},uniforms:{inputBuffer:new Y(null),threshold:new Y(0),smoothing:new Y(1),range:new Y(null)},blending:0,toneMapped:!1,depthWrite:!1,depthTest:!1,fragmentShader:Sl,vertexShader:Zc}),this.colorOutput=e,this.luminanceRange=t}set inputBuffer(e){this.uniforms.inputBuffer.value=e}setInputBuffer(e){this.uniforms.inputBuffer.value=e}get threshold(){return this.uniforms.threshold.value}set threshold(e){this.smoothing>0||e>0?this.defines.THRESHOLD=`1`:delete this.defines.THRESHOLD,this.uniforms.threshold.value=e}getThreshold(){return this.threshold}setThreshold(e){this.threshold=e}get smoothing(){return this.uniforms.smoothing.value}set smoothing(e){this.threshold>0||e>0?this.defines.THRESHOLD=`1`:delete this.defines.THRESHOLD,this.uniforms.smoothing.value=e}getSmoothingFactor(){return this.smoothing}setSmoothingFactor(e){this.smoothing=e}get useThreshold(){return this.threshold>0||this.smoothing>0}set useThreshold(e){}get colorOutput(){return this.defines.COLOR!==void 0}set colorOutput(e){e?this.defines.COLOR=`1`:delete this.defines.COLOR,this.needsUpdate=!0}isColorOutputEnabled(e){return this.colorOutput}setColorOutputEnabled(e){this.colorOutput=e}get useRange(){return this.luminanceRange!==null}set useRange(e){this.luminanceRange=null}get luminanceRange(){return this.uniforms.range.value}set luminanceRange(e){e===null?delete this.defines.RANGE:this.defines.RANGE=`1`,this.uniforms.range.value=e,this.needsUpdate=!0}getLuminanceRange(){return this.luminanceRange}setLuminanceRange(e){this.luminanceRange=e}},wl=class extends Jc{constructor({renderTarget:e,luminanceRange:t,colorOutput:n,resolutionScale:r=1,width:i=fl.AUTO_SIZE,height:a=fl.AUTO_SIZE,resolutionX:o=i,resolutionY:s=a}={}){super(`LuminancePass`),this.fullscreenMaterial=new Cl(n,t),this.needsSwap=!1,this.renderTarget=e,this.renderTarget===void 0&&(this.renderTarget=new Lt(1,1,{depthBuffer:!1}),this.renderTarget.texture.name=`LuminancePass.Target`);let c=this.resolution=new fl(this,o,s,r);c.addEventListener(`change`,e=>this.setSize(c.baseWidth,c.baseHeight))}get texture(){return this.renderTarget.texture}getTexture(){return this.renderTarget.texture}getResolution(){return this.resolution}render(e,t,n,r,i){let a=this.fullscreenMaterial;a.inputBuffer=t.texture,e.setRenderTarget(this.renderToScreen?null:this.renderTarget),e.render(this.scene,this.camera)}setSize(e,t){let n=this.resolution;n.setBaseSize(e,t),this.renderTarget.setSize(n.width,n.height)}initialize(e,t,n){n!==void 0&&n!==1009&&(this.renderTarget.texture.type=n,this.fullscreenMaterial.defines.FRAMEBUFFER_PRECISION_HIGH=`1`)}},Tl=`#ifdef FRAMEBUFFER_PRECISION_HIGH
uniform mediump sampler2D inputBuffer;
#else
uniform lowp sampler2D inputBuffer;
#endif
...
#include <colorspace_fragment>
}`,El=`uniform vec2 texelSize;varying vec2 vUv;varying vec2 vUv00;varying vec2 vUv01;varying vec2 vUv02;varying vec2 vUv03;varying vec2 vUv04;varying vec2 vUv05;varying vec2 vUv06;varying vec2 vUv07;varying vec2 vUv08;varying vec2 vUv09;varying vec2 vUv10;varying vec2 vUv11;void main(){vUv=position.xy*0.5+0.5;vUv00=vUv+texelSize*vec2(-1.0,1.0);vUv01=vUv+texelSize*vec2(1.0,1.0);vUv02=vUv+texelSize*vec2(-1.0,-1.0);vUv03=vUv+texelSize*vec2(1.0,-1.0);vUv04=vUv+texelSize*vec2(-2.0,2.0);vUv05=vUv+texelSize*vec2(0.0,2.0);vUv06=vUv+texelSize*vec2(2.0,2.0);vUv07=vUv+texelSize*vec2(-2.0,0.0);vUv08=vUv+texelSize*vec2(2.0,0.0);vUv09=vUv+texelSize*vec2(-2.0,-2.0);vUv10=vUv+texelSize*vec2(0.0,-2.0);vUv11=vUv+texelSize*vec2(2.0,-2.0);gl_Position=vec4(position.xy,1.0,1.0);}`,Dl=class extends _i{constructor(){super({name:`DownsamplingMaterial`,uniforms:{inputBuffer:new Y(null),texelSize:new Y(new W)},blending:0,toneMapped:!1,depthWrite:!1,depthTest:!1,fragmentShader:Tl,vertexShader:El})}set inputBuffer(e){this.uniforms.inputBuffer.value=e}setSize(e,t){this.uniforms.texelSize.value.set(1/e,1/t)}},Ol=`#ifdef FRAMEBUFFER_PRECISION_HIGH
...
#include <colorspace_fragment>
}`,kl=`uniform vec2 texelSize;varying vec2 vUv;varying vec2 vUv0;varying vec2 vUv1;varying vec2 vUv2;varying vec2 vUv3;varying vec2 vUv4;varying vec2 vUv5;varying vec2 vUv6;varying vec2 vUv7;void main(){vUv=position.xy*0.5+0.5;vUv0=vUv+texelSize*vec2(-1.0,1.0);vUv1=vUv+texelSize*vec2(0.0,1.0);vUv2=vUv+texelSize*vec2(1.0,1.0);vUv3=vUv+texelSize*vec2(-1.0,0.0);vUv4=vUv+texelSize*vec2(1.0,0.0);vUv5=vUv+texelSize*vec2(-1.0,-1.0);vUv6=vUv+texelSize*vec2(0.0,-1.0);vUv7=vUv+texelSize*vec2(1.0,-1.0);gl_Position=vec4(position.xy,1.0,1.0);}`,Al=class extends _i{constructor(){super({name:`UpsamplingMaterial`,uniforms:{inputBuffer:new Y(null),supportBuffer:new Y(null),texelSize:new Y(new W),radius:new Y(.85)},blending:0,toneMapped:!1,depthWrite:!1,depthTest:!1,fragmentShader:Ol,vertexShader:kl})}set inputBuffer(e){this.uniforms.inputBuffer.value=e}set supportBuffer(e){this.uniforms.supportBuffer.value=e}get radius(){return this.uniforms.radius.value}set radius(e){this.uniforms.radius.value=e}setSize(e,t){this.uniforms.texelSize.value.set(1/e,1/t)}},jl=class extends Jc{constructor(){super(`MipmapBlurPass`),this.needsSwap=!1,this.renderTarget=new Lt(1,1,{depthBuffer:!1}),this.renderTarget.texture.name=`Upsampling.Mipmap0`,this.downsamplingMipmaps=[],this.upsamplingMipmaps=[],this.downsamplingMaterial=new Dl,this.upsamplingMaterial=new Al,this.resolution=new W}get texture(){return this.renderTarget.texture}get levels(){return this.downsamplingMipmaps.length}set levels(e){if(this.levels!==e){let t=this.renderTarget;this.dispose(),this.downsamplingMipmaps=[],this.upsamplingMipmaps=[];for(let n=0;n<e;++n){let e=t.clone();e.texture.name=`Downsampling.Mipmap`+n,this.downsamplingMipmaps.push(e)}this.upsamplingMipmaps.push(t);for(let n=1,r=e-1;n<r;++n){let e=t.clone();e.texture.name=`Upsampling.Mipmap`+n,this.upsamplingMipmaps.push(e)}this.setSize(this.resolution.x,this.resolution.y)}}get radius(){return this.upsamplingMaterial.radius}set radius(e){this.upsamplingMaterial.radius=e}render(e,t,n,r,i){let{scene:a,camera:o}=this,{downsamplingMaterial:s,upsamplingMaterial:c}=this,{downsamplingMipmaps:l,upsamplingMipmaps:u}=this,d=t;this.fullscreenMaterial=s;for(let t=0,n=l.length;t<n;++t){let n=l[t];s.setSize(d.width,d.height),s.inputBuffer=d.texture,e.setRenderTarget(n),e.render(a,o),d=n}this.fullscreenMaterial=c;for(let t=u.length-1;t>=0;--t){let n=u[t];c.setSize(d.width,d.height),c.inputBuffer=d.texture,c.supportBuffer=l[t].texture,e.setRenderTarget(n),e.render(a,o),d=n}}setSize(e,t){let n=this.resolution;n.set(e,t);let r=n.width,i=n.height;for(let e=0,t=this.downsamplingMipmaps.length;e<t;++e)r=Math.round(r*.5),i=Math.round(i*.5),this.downsamplingMipmaps[e].setSize(r,i),e<this.upsamplingMipmaps.length&&this.upsamplingMipmaps[e].setSize(r,i)}initialize(e,t,n){if(n!==void 0){let t=this.downsamplingMipmaps.concat(this.upsamplingMipmaps);for(let e of t)e.texture.type=n;if(n!==1009)this.downsamplingMaterial.defines.FRAMEBUFFER_PRECISION_HIGH=`1`,this.upsamplingMaterial.defines.FRAMEBUFFER_PRECISION_HIGH=`1`;else if(e!==null&&e.outputColorSpace===`srgb`)for(let e of t)e.texture.colorSpace=Ke}}dispose(){super.dispose();for(let e of this.downsamplingMipmaps.concat(this.upsamplingMipmaps))e.dispose()}},Ml=`#ifdef FRAMEBUFFER_PRECISION_HIGH
uniform mediump sampler2D map;
#else
uniform lowp sampler2D map;
#endif
uniform float intensity;void mainImage(const in vec4 inputColor,const in vec2 uv,out vec4 outputColor){outputColor=texture2D(map,uv)*intensity;}`,Nl=class extends hl{constructor({blendFunction:e=$.SCREEN,luminanceThreshold:t=1,luminanceSmoothing:n=.03,mipmapBlur:r=!0,intensity:i=1,radius:a=.85,levels:o=8,kernelSize:s=gl.LARGE,resolutionScale:c=.5,width:l=fl.AUTO_SIZE,height:u=fl.AUTO_SIZE,resolutionX:d=l,resolutionY:f=u}={}){super(`BloomEffect`,Ml,{blendFunction:e,uniforms:new Map([[`map`,new Y(null)],[`intensity`,new Y(i)]])}),this.renderTarget=new Lt(1,1,{depthBuffer:!1}),this.renderTarget.texture.name=`Bloom.Target`,this.blurPass=new xl({kernelSize:s}),this.luminancePass=new wl({colorOutput:!0}),this.luminanceMaterial.threshold=t,this.luminanceMaterial.smoothing=n,this.mipmapBlurPass=new jl,this.mipmapBlurPass.enabled=r,this.mipmapBlurPass.radius=a,this.mipmapBlurPass.levels=o,this.uniforms.get(`map`).value=r?this.mipmapBlurPass.texture:this.renderTarget.texture;let p=this.resolution=new fl(this,d,f,c);p.addEventListener(`change`,e=>this.setSize(p.baseWidth,p.baseHeight))}get texture(){return this.mipmapBlurPass.enabled?this.mipmapBlurPass.texture:this.renderTarget.texture}getTexture(){return this.texture}getResolution(){return this.resolution}getBlurPass(){return this.blurPass}getLuminancePass(){return this.luminancePass}get luminanceMaterial(){return this.luminancePass.fullscreenMaterial}getLuminanceMaterial(){return this.luminancePass.fullscreenMaterial}get width(){return this.resolution.width}set width(e){this.resolution.preferredWidth=e}get height(){return this.resolution.height}set height(e){this.resolution.preferredHeight=e}get dithering(){return this.blurPass.dithering}set dithering(e){this.blurPass.dithering=e}get kernelSize(){return this.blurPass.kernelSize}set kernelSize(e){this.blurPass.kernelSize=e}get distinction(){return console.warn(this.name,`distinction was removed`),1}set distinction(e){console.warn(this.name,`distinction was removed`)}get intensity(){return this.uniforms.get(`intensity`).value}set intensity(e){this.uniforms.get(`intensity`).value=e}getIntensity(){return this.intensity}setIntensity(e){this.intensity=e}getResolutionScale(){return this.resolution.scale}setResolutionScale(e){this.resolution.scale=e}update(e,t,n){let r=this.renderTarget,i=this.luminancePass;i.enabled?(i.render(e,t),this.mipmapBlurPass.enabled?this.mipmapBlurPass.render(e,i.renderTarget):this.blurPass.render(e,i.renderTarget,r)):this.mipmapBlurPass.enabled?this.mipmapBlurPass.render(e,t):this.blurPass.render(e,t,r)}setSize(e,t){let n=this.resolution;n.setBaseSize(e,t),this.renderTarget.setSize(n.width,n.height),this.blurPass.resolution.copy(n),this.luminancePass.setSize(e,t),this.mipmapBlurPass.setSize(e,t)}initialize(e,t,n){this.blurPass.initialize(e,t,n),this.luminancePass.initialize(e,t,n),this.mipmapBlurPass.initialize(e,t,n),n!==void 0&&(this.renderTarget.texture.type=n,e!==null&&e.outputColorSpace===`srgb`&&(this.renderTarget.texture.colorSpace=Ke))}},Pl=class extends Jc{constructor(e,t=`inputBuffer`){super(`ShaderPass`),this.fullscreenMaterial=e,this.input=t}setInput(e){this.input=e}render(e,t,n,r,i){let a=this.fullscreenMaterial.uniforms;t!==null&&a!==void 0&&a[this.input]!==void 0&&(a[this.input].value=t.texture),e.setRenderTarget(this.renderToScreen?null:n),e.render(this.scene,this.camera)}initialize(e,t,n){n!==void 0&&n!==1009&&(this.fullscreenMaterial.defines.FRAMEBUFFER_PRECISION_HIGH=`1`)}},Fl=class extends Jc{constructor(e,t,n=null){super(`RenderPass`,e,t),this.needsSwap=!1,this.needsDepthBlit=!0,this.clearPass=new tl,this.overrideMaterialManager=n===null?null:new ul(n),this.ignoreBackground=!1,this.skipShadowMapUpdate=!1,this.selection=null}set mainScene(e){this.scene=e}set mainCamera(e){this.camera=e}get renderToScreen(){return super.renderToScreen}set renderToScreen(e){super.renderToScreen=e,this.clearPass.renderToScreen=e}get overrideMaterial(){let e=this.overrideMaterialManager;return e===null?null:e.material}set overrideMaterial(e){let t=this.overrideMaterialManager;e===null?t!==null&&(t.dispose(),this.overrideMaterialManager=null):t===null?this.overrideMaterialManager=new ul(e):t.setMaterial(e)}getOverrideMaterial(){return this.overrideMaterial}setOverrideMaterial(e){this.overrideMaterial=e}get clear(){return this.clearPass.enabled}set clear(e){this.clearPass.enabled=e}getSelection(){return this.selection}setSelection(e){this.selection=e}isBackgroundDisabled(){return this.ignoreBackground}setBackgroundDisabled(e){this.ignoreBackground=e}isShadowMapDisabled(){return this.skipShadowMapUpdate}setShadowMapDisabled(e){this.skipShadowMapUpdate=e}getClearPass(){return this.clearPass}render(e,t,n,r,i){let a=this.scene,o=this.camera,s=this.selection,c=o.layers.mask,l=a.background,u=e.shadowMap.autoUpdate,d=this.renderToScreen?null:t;s!==null&&o.layers.set(s.getLayer()),this.skipShadowMapUpdate&&(e.shadowMap.autoUpdate=!1),(this.ignoreBackground||this.clearPass.overrideClearColor!==null)&&(a.background=null),this.clearPass.enabled&&this.clearPass.render(e,t),e.setRenderTarget(d),this.overrideMaterialManager===null?e.render(a,o):this.overrideMaterialManager.render(e,a,o),o.layers.mask=c,a.background=l,e.shadowMap.autoUpdate=u}},Il={DEPTH:0,LUMA:1,COLOR:2},Ll={DISABLED:0,DEPTH:1,CUSTOM:2},Rl={LOW:0,MEDIUM:1,HIGH:2,ULTRA:3},zl={LINEAR:0,REINHARD:1,REINHARD2:2,REINHARD2_ADAPTIVE:3,UNCHARTED2:4,OPTIMIZED_CINEON:5,CINEON:5,ACES_FILMIC:6,AGX:7,NEUTRAL:8};Math.PI*.5;var Bl=`varying vec2 vUv;varying vec2 vUv0;varying vec2 vUv1;
...
#endif
}`,Vl=`uniform vec2 texelSize;varying vec2 vUv;varying vec2 vUv0;varying vec2 vUv1;
#if EDGE_DETECTION_MODE != 0
varying vec2 vUv2;varying vec2 vUv3;varying vec2 vUv4;varying vec2 vUv5;
#endif
...
#endif
gl_Position=vec4(position.xy,1.0,1.0);}`,Hl=class extends _i{constructor(e=new W,t=Il.COLOR){super({name:`EdgeDetectionMaterial`,defines:{THREE_REVISION:`183`.replace(/\D+/g,``),LOCAL_CONTRAST_ADAPTATION_FACTOR:`2.0`,EDGE_THRESHOLD:`0.1`,DEPTH_THRESHOLD:`0.01`,PREDICATION_MODE:`0`,PREDICATION_THRESHOLD:`0.01`,PREDICATION_SCALE:`2.0`,PREDICATION_STRENGTH:`1.0`,DEPTH_PACKING:`0`},uniforms:{inputBuffer:new Y(null),depthBuffer:new Y(null),predicationBuffer:new Y(null),texelSize:new Y(e)},blending:0,toneMapped:!1,depthWrite:!1,depthTest:!1,fragmentShader:Bl,vertexShader:Vl}),this.edgeDetectionMode=t}set depthBuffer(e){this.uniforms.depthBuffer.value=e}set depthPacking(e){this.defines.DEPTH_PACKING=e.toFixed(0),this.needsUpdate=!0}setDepthBuffer(e,t=Ge){this.depthBuffer=e,this.depthPacking=t}get edgeDetectionMode(){return Number(this.defines.EDGE_DETECTION_MODE)}set edgeDetectionMode(e){this.defines.EDGE_DETECTION_MODE=e.toFixed(0),this.needsUpdate=!0}getEdgeDetectionMode(){return this.edgeDetectionMode}setEdgeDetectionMode(e){this.edgeDetectionMode=e}get localContrastAdaptationFactor(){return Number(this.defines.LOCAL_CONTRAST_ADAPTATION_FACTOR)}set localContrastAdaptationFactor(e){this.defines.LOCAL_CONTRAST_ADAPTATION_FACTOR=e.toFixed(`6`),this.needsUpdate=!0}getLocalContrastAdaptationFactor(){return this.localContrastAdaptationFactor}setLocalContrastAdaptationFactor(e){this.localContrastAdaptationFactor=e}get edgeDetectionThreshold(){return Number(this.defines.EDGE_THRESHOLD)}set edgeDetectionThreshold(e){this.defines.EDGE_THRESHOLD=e.toFixed(`6`),this.defines.DEPTH_THRESHOLD=(e*.1).toFixed(`6`),this.needsUpdate=!0}getEdgeDetectionThreshold(){return this.edgeDetectionThreshold}setEdgeDetectionThreshold(e){this.edgeDetectionThreshold=e}get predicationMode(){return Number(this.defines.PREDICATION_MODE)}set predicationMode(e){this.defines.PREDICATION_MODE=e.toFixed(0),this.needsUpdate=!0}getPredicationMode(){return this.predicationMode}setPredicationMode(e){this.predicationMode=e}set predicationBuffer(e){this.uniforms.predicationBuffer.value=e}setPredicationBuffer(e){this.uniforms.predicationBuffer.value=e}get predicationThreshold(){return Number(this.defines.PREDICATION_THRESHOLD)}set predicationThreshold(e){this.defines.PREDICATION_THRESHOLD=e.toFixed(`6`),this.needsUpdate=!0}getPredicationThreshold(){return this.predicationThreshold}setPredicationThreshold(e){this.predicationThreshold=e}get predicationScale(){return Number(this.defines.PREDICATION_SCALE)}set predicationScale(e){this.defines.PREDICATION_SCALE=e.toFixed(`6`),this.needsUpdate=!0}getPredicationScale(){return this.predicationScale}setPredicationScale(e){this.predicationScale=e}get predicationStrength(){return Number(this.defines.PREDICATION_STRENGTH)}set predicationStrength(e){this.defines.PREDICATION_STRENGTH=e.toFixed(`6`),this.needsUpdate=!0}getPredicationStrength(){return this.predicationStrength}setPredicationStrength(e){this.predicationStrength=e}setSize(e,t){this.uniforms.texelSize.value.set(1/e,1/t)}},Ul=`#define sampleLevelZeroOffset(t, coord, offset) texture2D(t, coord + offset * texelSize)
#if __VERSION__ < 300
...
#endif
l0=max(minLuminance,l0);l1=max(minLuminance,l1);float adaptedLum=l0+(l1-l0)*(1.0-exp(-deltaTime*tau));gl_FragColor=(adaptedLum==1.0)?vec4(1.0):packFloatToRGBA(adaptedLum);}`,Ql=class extends _i{constructor(){super({name:`AdaptiveLuminanceMaterial`,defines:{MIP_LEVEL_1X1:`0.0`},uniforms:{luminanceBuffer0:new Y(null),luminanceBuffer1:new Y(null),minLuminance:new Y(.01),deltaTime:new Y(0),tau:new Y(1)},extensions:{shaderTextureLOD:!0},blending:0,toneMapped:!1,depthWrite:!1,depthTest:!1,fragmentShader:Zl,vertexShader:Zc})}set luminanceBuffer0(e){this.uniforms.luminanceBuffer0.value=e}setLuminanceBuffer0(e){this.uniforms.luminanceBuffer0.value=e}set luminanceBuffer1(e){this.uniforms.luminanceBuffer1.value=e}setLuminanceBuffer1(e){this.uniforms.luminanceBuffer1.value=e}set mipLevel1x1(e){this.defines.MIP_LEVEL_1X1=e.toFixed(1),this.needsUpdate=!0}setMipLevel1x1(e){this.mipLevel1x1=e}set deltaTime(e){this.uniforms.deltaTime.value=e}setDeltaTime(e){this.uniforms.deltaTime.value=e}get minLuminance(){return this.uniforms.minLuminance.value}set minLuminance(e){this.uniforms.minLuminance.value=e}getMinLuminance(){return this.uniforms.minLuminance.value}setMinLuminance(e){this.uniforms.minLuminance.value=e}get adaptationRate(){return this.uniforms.tau.value}set adaptationRate(e){this.uniforms.tau.value=e}getAdaptationRate(){return this.uniforms.tau.value}setAdaptationRate(e){this.uniforms.tau.value=e}},$l=class extends Jc{constructor(e,{minLuminance:t=.01,adaptationRate:n=1}={}){super(`AdaptiveLuminancePass`),this.fullscreenMaterial=new Ql,this.needsSwap=!1,this.renderTargetPrevious=new Lt(1,1,{minFilter:m,magFilter:m,depthBuffer:!1}),this.renderTargetPrevious.texture.name=`Luminance.Previous`;let r=this.fullscreenMaterial;r.luminanceBuffer0=this.renderTargetPrevious.texture,r.luminanceBuffer1=e,r.minLuminance=t,r.adaptationRate=n,this.renderTargetAdapted=this.renderTargetPrevious.clone(),this.renderTargetAdapted.texture.name=`Luminance.Adapted`,this.copyPass=new $c(this.renderTargetPrevious,!1)}get texture(){return this.renderTargetAdapted.texture}getTexture(){return this.renderTargetAdapted.texture}set mipLevel1x1(e){this.fullscreenMaterial.mipLevel1x1=e}get adaptationRate(){return this.fullscreenMaterial.adaptationRate}set adaptationRate(e){this.fullscreenMaterial.adaptationRate=e}render(e,t,n,r,i){this.fullscreenMaterial.deltaTime=r,e.setRenderTarget(this.renderToScreen?null:this.renderTargetAdapted),e.render(this.scene,this.camera),this.copyPass.render(e,this.renderTargetAdapted)}},eu=`#include <tonemapping_pars_fragment>
...
#endif
}`,tu=class extends hl{constructor({blendFunction:e=$.SRC,adaptive:t=!1,mode:n=t?zl.REINHARD2_ADAPTIVE:zl.AGX,resolution:r=256,maxLuminance:i=4,whitePoint:a=i,middleGrey:o=.6,minLuminance:s=.01,averageLuminance:c=1,adaptationRate:l=1}={}){super(`ToneMappingEffect`,eu,{blendFunction:e,uniforms:new Map([[`luminanceBuffer`,new Y(null)],[`maxLuminance`,new Y(i)],[`whitePoint`,new Y(a)],[`middleGrey`,new Y(o)],[`averageLuminance`,new Y(c)]])}),this.renderTargetLuminance=new Lt(1,1,{minFilter:y,depthBuffer:!1}),this.renderTargetLuminance.texture.generateMipmaps=!0,this.renderTargetLuminance.texture.name=`Luminance`,this.luminancePass=new wl({renderTarget:this.renderTargetLuminance}),this.adaptiveLuminancePass=new $l(this.luminancePass.texture,{minLuminance:s,adaptationRate:l}),this.uniforms.get(`luminanceBuffer`).value=this.adaptiveLuminancePass.texture,this.resolution=r,this.mode=n}get mode(){return Number(this.defines.get(`TONE_MAPPING_MODE`))}set mode(e){if(this.mode===e)return;let t=`183`.replace(/\D+/g,``)>=168?`CineonToneMapping(texel)`:`OptimizedCineonToneMapping(texel)`;switch(this.defines.clear(),this.defines.set(`TONE_MAPPING_MODE`,e.toFixed(0)),e){case zl.LINEAR:this.defines.set(`toneMapping(texel)`,`LinearToneMapping(texel)`);break;case zl.REINHARD:this.defines.set(`toneMapping(texel)`,`ReinhardToneMapping(texel)`);break;case zl.CINEON:case zl.OPTIMIZED_CINEON:this.defines.set(`toneMapping(texel)`,t);break;case zl.ACES_FILMIC:this.defines.set(`toneMapping(texel)`,`ACESFilmicToneMapping(texel)`);break;case zl.AGX:this.defines.set(`toneMapping(texel)`,`AgXToneMapping(texel)`);break;case zl.NEUTRAL:this.defines.set(`toneMapping(texel)`,`NeutralToneMapping(texel)`);break;default:this.defines.set(`toneMapping(texel)`,`texel`);break}this.adaptiveLuminancePass.enabled=e===zl.REINHARD2_ADAPTIVE,this.setChanged()}getMode(){return this.mode}setMode(e){this.mode=e}get whitePoint(){return this.uniforms.get(`whitePoint`).value}set whitePoint(e){this.uniforms.get(`whitePoint`).value=e}get middleGrey(){return this.uniforms.get(`middleGrey`).value}set middleGrey(e){this.uniforms.get(`middleGrey`).value=e}get averageLuminance(){return this.uniforms.get(`averageLuminance`).value}set averageLuminance(e){this.uniforms.get(`averageLuminance`).value=e}get adaptiveLuminanceMaterial(){return this.adaptiveLuminancePass.fullscreenMaterial}getAdaptiveLuminanceMaterial(){return this.adaptiveLuminanceMaterial}get resolution(){return this.luminancePass.resolution.width}set resolution(e){let t=Math.max(0,Math.ceil(Math.log2(e))),n=2**t;this.luminancePass.resolution.setPreferredSize(n,n),this.adaptiveLuminanceMaterial.mipLevel1x1=t}getResolution(){return this.resolution}setResolution(e){this.resolution=e}get adaptive(){return this.mode===zl.REINHARD2_ADAPTIVE}set adaptive(e){this.mode=e?zl.REINHARD2_ADAPTIVE:zl.REINHARD2}get adaptationRate(){return this.adaptiveLuminanceMaterial.adaptationRate}set adaptationRate(e){this.adaptiveLuminanceMaterial.adaptationRate=e}get distinction(){return console.warn(this.name,`distinction was removed.`),1}set distinction(e){console.warn(this.name,`distinction was removed.`)}update(e,t,n){this.adaptiveLuminancePass.enabled&&(this.luminancePass.render(e,t),this.adaptiveLuminancePass.render(e,null,null,n))}initialize(e,t,n){this.adaptiveLuminancePass.initialize(e,t,n)}},nu=`#include <common>
#include <packing>
#include <dithering_pars_fragment>
#define packFloatToRGBA(v) packDepthToRGBA(v)
#define unpackRGBAToFloat(v) unpackRGBAToDepth(v)
...
#endif
#include <dithering_fragment>
}`,ru=`uniform vec2 resolution;uniform vec2 texelSize;uniform float cameraNear;uniform float cameraFar;uniform float aspect;uniform float time;varying vec2 vUv;VERTEX_HEAD void main(){vUv=position.xy*0.5+0.5;VERTEX_MAIN_SUPPORT gl_Position=vec4(position.xy,1.0,1.0);}`,iu=class extends _i{constructor(e,t,n,r,i=!1){super({name:`EffectMaterial`,defines:{THREE_REVISION:`183`.replace(/\D+/g,``),DEPTH_PACKING:`0`,ENCODE_OUTPUT:`1`},uniforms:{inputBuffer:new Y(null),depthBuffer:new Y(null),resolution:new Y(new W),texelSize:new Y(new W),cameraNear:new Y(.3),cameraFar:new Y(1e3),aspect:new Y(1),time:new Y(0)},blending:0,toneMapped:!1,depthWrite:!1,depthTest:!1,dithering:i}),e&&this.setShaderParts(e),t&&this.setDefines(t),n&&this.setUniforms(n),this.copyCameraSettings(r)}set inputBuffer(e){this.uniforms.inputBuffer.value=e}setInputBuffer(e){this.uniforms.inputBuffer.value=e}get depthBuffer(){return this.uniforms.depthBuffer.value}set depthBuffer(e){this.uniforms.depthBuffer.value=e}get depthPacking(){return Number(this.defines.DEPTH_PACKING)}set depthPacking(e){this.defines.DEPTH_PACKING=e.toFixed(0),this.needsUpdate=!0}setDepthBuffer(e,t=Ge){this.depthBuffer=e,this.depthPacking=t}setShaderData(e){this.setShaderParts(e.shaderParts),this.setDefines(e.defines),this.setUniforms(e.uniforms),this.setExtensions(e.extensions)}setShaderParts(e){return this.fragmentShader=nu.replace(Q.FRAGMENT_HEAD,e.get(Q.FRAGMENT_HEAD)||``).replace(Q.FRAGMENT_MAIN_UV,e.get(Q.FRAGMENT_MAIN_UV)||``).replace(Q.FRAGMENT_MAIN_IMAGE,e.get(Q.FRAGMENT_MAIN_IMAGE)||``),this.vertexShader=ru.replace(Q.VERTEX_HEAD,e.get(Q.VERTEX_HEAD)||``).replace(Q.VERTEX_MAIN_SUPPORT,e.get(Q.VERTEX_MAIN_SUPPORT)||``),this.needsUpdate=!0,this}setDefines(e){for(let t of e.entries())this.defines[t[0]]=t[1];return this.needsUpdate=!0,this}setUniforms(e){for(let t of e.entries())this.uniforms[t[0]]=t[1];return this}setExtensions(e){this.extensions={};for(let t of e)this.extensions[t]=!0;return this}get encodeOutput(){return this.defines.ENCODE_OUTPUT!==void 0}set encodeOutput(e){this.encodeOutput!==e&&(e?this.defines.ENCODE_OUTPUT=`1`:delete this.defines.ENCODE_OUTPUT,this.needsUpdate=!0)}isOutputEncodingEnabled(e){return this.encodeOutput}setOutputEncodingEnabled(e){this.encodeOutput=e}get time(){return this.uniforms.time.value}set time(e){this.uniforms.time.value=e}setDeltaTime(e){this.uniforms.time.value+=e}adoptCameraSettings(e){this.copyCameraSettings(e)}copyCameraSettings(e){e&&(this.uniforms.cameraNear.value=e.near,this.uniforms.cameraFar.value=e.far,e instanceof sa?this.defines.PERSPECTIVE_CAMERA=`1`:delete this.defines.PERSPECTIVE_CAMERA,this.needsUpdate=!0)}setSize(e,t){let n=this.uniforms;n.resolution.value.set(e,t),n.texelSize.value.set(1/e,1/t),n.aspect.value=e/t}static get Section(){return Q}};Number(`183`.replace(/\D+/g,``));var au=255/256;new Float32Array([au/256**3,au/256**2,au/256,au]),new Float32Array([au,au/256,au/256**2,1/256**3]);function ou(e,t,n){for(let r of t){let t=`$1`+e+r.charAt(0).toUpperCase()+r.slice(1),i=RegExp(`([^\\.])(\\b`+r+`\\b)`,`g`);for(let e of n.entries())e[1]!==null&&n.set(e[0],e[1].replace(i,t))}}function su(e,t,n){let r=t.getFragmentShader(),i=t.getVertexShader(),a=r!==void 0&&/mainImage/.test(r),o=r!==void 0&&/mainUv/.test(r);if(n.attributes|=t.getAttributes(),r===void 0)throw Error(`Missing fragment shader (${t.name})`);if(o&&(n.attributes&sl.CONVOLUTION)!==0)throw Error(`Effects that transform UVs are incompatible with convolution effects (${t.name})`);if(!a&&!o)throw Error(`Could not find mainImage or mainUv function (${t.name})`);{let s=/\w+\s+(\w+)\([\w\s,]*\)\s*{/g,c=n.shaderParts,l=c.get(Q.FRAGMENT_HEAD)||``,u=c.get(Q.FRAGMENT_MAIN_UV)||``,d=c.get(Q.FRAGMENT_MAIN_IMAGE)||``,f=c.get(Q.VERTEX_HEAD)||``,p=c.get(Q.VERTEX_MAIN_SUPPORT)||``,m=new Set,h=new Set;if(o&&(u+=`	${e}MainUv(UV);
...
`;for(let e of i.matchAll(/(?:varying\s+\w+\s+([\S\s]*?);)/g))for(let t of e[1].split(/\s*,\s*/))n.varyings.add(t),m.add(t),h.add(t);for(let e of i.matchAll(s))h.add(e[1])}for(let e of r.matchAll(s))h.add(e[1]);for(let e of t.defines.keys())h.add(e.replace(/\([\w\s,]*\)/g,``));for(let e of t.uniforms.keys())h.add(e);h.delete(`while`),h.delete(`for`),h.delete(`if`),t.uniforms.forEach((t,r)=>n.uniforms.set(e+r.charAt(0).toUpperCase()+r.slice(1),t)),t.defines.forEach((t,r)=>n.defines.set(e+r.charAt(0).toUpperCase()+r.slice(1),t));let g=new Map([[`fragment`,r],[`vertex`,i]]);ou(e,h,n.defines),ou(e,h,g),r=g.get(`fragment`),i=g.get(`vertex`);let _=t.blendMode;if(n.blendModes.set(_.blendFunction,_),a){t.inputColorSpace!==null&&t.inputColorSpace!==n.colorSpace&&(d+=t.inputColorSpace===`srgb`?`color0 = sRGBTransferOETF(color0);
	...
	`),t.outputColorSpace===``?t.inputColorSpace!==null&&(n.colorSpace=t.inputColorSpace):n.colorSpace=t.outputColorSpace,d+=`${e}MainImage(color0, UV, `,(n.attributes&sl.DEPTH)!==0&&/MainImage *\([\w\s,]*?depth[\w\s,]*?\)/.test(r)&&(d+=`depth, `,n.readDepth=!0),d+=`color1);
...
#`));this.skipRendering=t===0,this.needsSwap=!this.skipRendering,this.fullscreenMaterial.setShaderData(e)}recompile(){this.updateMaterial()}getDepthTexture(){return this.fullscreenMaterial.depthBuffer}setDepthTexture(e,t=Ge){this.fullscreenMaterial.depthBuffer=e,this.fullscreenMaterial.depthPacking=t;for(let n of this.effects)n.setDepthTexture(e,t)}render(e,t,n,r,i){for(let n of this.effects)n.update(e,t,r);if(!this.skipRendering||this.renderToScreen){let i=this.fullscreenMaterial;i.inputBuffer=t.texture,i.time+=r*this.timeScale,e.setRenderTarget(this.renderToScreen?null:n),e.render(this.scene,this.camera)}}setSize(e,t){this.fullscreenMaterial.setSize(e,t);for(let n of this.effects)n.setSize(e,t)}initialize(e,t,n){this.renderer=e;for(let r of this.effects)r.initialize(e,t,n);this.updateMaterial(),n!==void 0&&n!==1009&&(this.fullscreenMaterial.defines.FRAMEBUFFER_PRECISION_HIGH=`1`)}dispose(){super.dispose();for(let e of this.effects)e.removeEventListener(`change`,this.listener),e.dispose()}handleEvent(e){switch(e.type){case`change`:this.recompile();break}}};new Float32Array([0,0,0]),new Float32Array([1,0,0]),new Float32Array([1,1,0]),new Float32Array([1,1,1]),new Float32Array([0,0,0]),new Float32Array([1,0,0]),new Float32Array([1,0,1]),new Float32Array([1,1,1]),new Float32Array([0,0,0]),new Float32Array([0,0,1]),new Float32Array([1,0,1]),new Float32Array([1,1,1]),new Float32Array([0,0,0]),new Float32Array([0,1,0]),new Float32Array([1,1,0]),new Float32Array([1,1,1]),new Float32Array([0,0,0]),new Float32Array([0,1,0]),new Float32Array([0,1,1]),new Float32Array([1,1,1]),new Float32Array([0,0,0]),new Float32Array([0,0,1]),new Float32Array([0,1,1]),new Float32Array([1,1,1]),new Float32Array([0,-.25,.25,-.125,.125,-.375,.375]),new Float32Array([0,0]),new Float32Array([.25,-.25]),new Float32Array([-.25,.25]),new Float32Array([.125,-.125]),new Float32Array([-.125,.125]),new Uint8Array([0,0]),new Uint8Array([3,0]),new Uint8Array([0,3]),new Uint8Array([3,3]),new Uint8Array([1,0]),new Uint8Array([4,0]),new Uint8Array([1,3]),new Uint8Array([4,3]),new Uint8Array([0,1]),new Uint8Array([3,1]),new Uint8Array([0,4]),new Uint8Array([3,4]),new Uint8Array([1,1]),new Uint8Array([4,1]),new Uint8Array([1,4]),new Uint8Array([4,4]),new Uint8Array([0,0]),new Uint8Array([1,0]),new Uint8Array([0,2]),new Uint8Array([1,2]),new Uint8Array([2,0]),new Uint8Array([3,0]),new Uint8Array([2,2]),new Uint8Array([3,2]),new Uint8Array([0,1]),new Uint8Array([1,1]),new Uint8Array([0,3]),new Uint8Array([1,3]),new Uint8Array([2,1]),new Uint8Array([3,1]),new Uint8Array([2,3]),new Uint8Array([3,3]),uu(0,0,0,0),new Float32Array([0,0,0,0]),uu(0,0,0,1),new Float32Array([0,0,0,1]),uu(0,0,1,0),new Float32Array([0,0,1,0]),uu(0,0,1,1),new Float32Array([0,0,1,1]),uu(0,1,0,0),new Float32Array([0,1,0,0]),uu(0,1,0,1),new Float32Array([0,1,0,1]),uu(0,1,1,0),new Float32Array([0,1,1,0]),uu(0,1,1,1),new Float32Array([0,1,1,1]),uu(1,0,0,0),new Float32Array([1,0,0,0]),uu(1,0,0,1),new Float32Array([1,0,0,1]),uu(1,0,1,0),new Float32Array([1,0,1,0]),uu(1,0,1,1),new Float32Array([1,0,1,1]),uu(1,1,0,0),new Float32Array([1,1,0,0]),uu(1,1,0,1),new Float32Array([1,1,0,1]),uu(1,1,1,0),new Float32Array([1,1,1,0]),uu(1,1,1,1),new Float32Array([1,1,1,1]);function lu(e,t,n){return e+(t-e)*n}function uu(e,t,n,r){return lu(lu(e,t,.75),lu(n,r,.75),.875)}var du=null,fu=null,pu=null,mu=null,hu=null,gu=!1,_u=!1,vu=null,yu=null,bu=new W,xu=1,Su=null,Cu=null,wu=new G(-.5,.6,-.42).normalize(),Tu=`./`;function Eu(){return gu}function Du(e,t){let n=new qi().load(Tu+e);return n.wrapS=n.wrapT=d,n.colorSpace=t?Ke:``,n.anisotropy=8,n}function Ou(e){return{col:Du(`showcase/terrain/${e}_col.png`,!0),nrm:Du(`showcase/terrain/${e}_nrm.png`,!1),rgh:Du(`showcase/terrain/${e}_rgh.png`,!1)}}function ku(e,n){try{du=new Wc({canvas:e,antialias:!1,powerPreference:`high-performance`}),du.setPixelRatio(1),du.outputColorSpace=Ke,du.toneMapping=0,du.shadowMap.enabled=!0,du.shadowMap.type=1,fu=new wn,pu=new sa(45,1,2,8e3),pu.up.set(0,1,0);let n=wu;(l.cMax-l.cMin+4)*t*.5,(l.rMax-l.rMin+4)*(1.5*6)*.5;let r=156*.62;hu=new ua(16773328,4.2),hu.position.set(l.cx+n.x*900,n.y*900,l.cz+n.z*900),hu.castShadow=!0,hu.shadow.mapSize.set(4096,4096);let i=hu.shadow.camera;i.near=50,i.far=2200,i.left=-96.72,i.right=r,i.top=r,i.bottom=-96.72,i.updateProjectionMatrix(),hu.shadow.bias=-4e-4,hu.shadow.normalBias=1,fu.add(hu),hu.target.position.set(l.cx,0,l.cz),fu.add(hu.target),fu.add(new Yi(12375791,4867126,.35)),new Kc().load(`./showcase/sky_1k.hdr`,e=>{if(!du||!fu)return;let t=new Za(du);fu.environment=t.fromEquirectangular(e).texture,e.mapping=303,fu.background=e,fu.backgroundBlurriness=0,t.dispose()},void 0,()=>{fu&&(fu.background=new J(12375788))}),fu.fog=new Cn(12900584,2600,7200),mu=new ol(du,{frameBufferType:D}),mu.addPass(new Fl(fu,pu));let a=new Nl({intensity:.09,luminanceThreshold:1.35,luminanceSmoothing:.2,mipmapBlur:!0}),o=new tu({mode:zl.ACES_FILMIC});mu.addPass(new cu(pu,a,o,new Xl)),gu=!0}catch(e){gu=!1,console.warn(`showcase init failed, falling back to world renderer`,e)}}var Au=`
  float _hash(vec2 p){ return fract(sin(dot(p,vec2(41.3,289.1)))*43758.5); }
  float vnoise(vec2 p){ vec2 i=floor(p),f=fract(p); f=f*f*(3.-2.*f);
    return mix(mix(_hash(i),_hash(i+vec2(1,0)),f.x),mix(_hash(i+vec2(0,1)),_hash(i+vec2(1,1)),f.x),f.y); }`,ju=`
  vec2 hexCenter(vec2 p){
    float R=6.0;
    float q=(0.57735027*p.x - 0.33333333*p.y)/R, r=(0.66666667*p.y)/R;
    float cx=q, cy=-q-r, cz=r;
    float rx=floor(cx+0.5), ry=floor(cy+0.5), rz=floor(cz+0.5);
    float dx=abs(rx-cx), dy=abs(ry-cy), dz=abs(rz-cz);
    if(dx>dy && dx>dz) rx=-ry-rz; else if(dy>dz) ry=-rx-rz; else rz=-rx-ry;
    return vec2(R*1.7320508*(rx+rz*0.5), R*1.5*rz);
  }
  float hexLine(vec2 p){
    vec2 lp = p - hexCenter(p);
    float d = max(abs(lp.x), max(abs(0.5*lp.x+0.8660254*lp.y), abs(-0.5*lp.x+0.8660254*lp.y)));
    return 1.0 - smoothstep(0.0, 0.24, 5.1961524 - d);   // 辺の近くで1（薄い線）
  }`;function Mu(e=!1){let n=Ou(`grass`),r=Ou(`rock`),i=Ou(`sand`),a=new yi({roughness:1,metalness:0});return a.envMapIntensity=.5,e&&(a.defines={USE_SHORE:1}),a.onBeforeCompile=e=>{e.uniforms.uGrassC={value:n.col},e.uniforms.uGrassN={value:n.nrm},e.uniforms.uGrassR={value:n.rgh},e.uniforms.uRockC={value:r.col},e.uniforms.uRockN={value:r.nrm},e.uniforms.uRockR={value:r.rgh},e.uniforms.uSandC={value:i.col},e.uniforms.uSandN={value:i.nrm},e.uniforms.uSandR={value:i.rgh},e.uniforms.uSeaY={value:2},e.vertexShader=e.vertexShader.replace(`#include <common>`,`#include <common>
varying vec3 vWPos;
varying vec3 vWNrm;
#ifdef USE_SHORE
...
varying float vShore;
 ...
 vShore = aShore;
        ...
        varying float vShore;
        #endif
        uniform sampler2D uGrassC,uGrassN,uGrassR,uRockC,uRockN,uRockR,uSandC,uSandN,uSandR;
        uniform float uSeaY;
        vec3 triC(sampler2D t, vec3 p, vec3 bw, float sc){
          return texture2D(t,p.zy/sc).rgb*bw.x + texture2D(t,p.xz/sc).rgb*bw.y + texture2D(t,p.xy/sc).rgb*bw.z;
        }
        ${Au}
        ${ju}`).replace(`#include <map_fragment>`,`
        vec3 wn = normalize(vWNrm);
        float slope = clamp(wn.y, 0.0, 1.0);            // 1=水平, 0=垂直
        vec3 bw = pow(abs(wn), vec3(4.0)); bw /= (bw.x+bw.y+bw.z);
        vec2 uvTop = vWPos.xz / (HW_MACRO);
        vec3 gCol = texture2D(uGrassC, uvTop).rgb;
        // 草を暖色寄りにし、大スケールのムラで単調さを消す（Civ7風の黄緑の草原）
        float gvar = vnoise(vWPos.xz * 0.03) * 0.6 + vnoise(vWPos.xz * 0.11) * 0.4;
        gCol *= mix(vec3(0.82,0.88,0.60), vec3(1.10,1.08,0.78), gvar);
        vec3 sCol = texture2D(uSandC, uvTop).rgb * vec3(0.82,0.76,0.60); // 暖色の砂浜
        vec3 rCol = triC(uRockC, vWPos, bw, HW_MACRO);
        // 重み: 砂=汀線帯の平坦地、岩=急斜面 or 高標高、草=既定
        #ifdef USE_SHORE
        float nearShore = smoothstep(3.4, 0.2, abs(vShore));           // 海岸線からの距離基準（正確な渚）
        #else
        float nearShore = smoothstep(0.75, 0.1, abs(vWPos.y - uSeaY));  // 高さ基準（汀線±の細い砂浜帯）
        #endif
        float wSand = nearShore * smoothstep(0.5, 0.8, slope);         // 浜は平坦地のみ（崖は岩）
        float wRock = 1.0 - smoothstep(0.55, 0.78, slope);
        wRock = max(wRock, smoothstep(24.0, 40.0, vWPos.y));
        wRock *= 1.0 - wSand;                                          // 浜では岩を抑える
        float wGrass = 1.0;
        float tot = wGrass + wRock*2.2 + wSand*3.2 + 1e-4;
        vec3 splat = (gCol*wGrass + rCol*wRock*2.2 + sCol*wSand*3.2)/tot;
        diffuseColor.rgb *= splat;
        // 海面下: 色付け（ターコイズ→紺）は水の板(islandWater)が担当。ここでは砂を自然色のまま
        // 残し（＝浅瀬で透けて見える底）、濡れでわずかに沈めて乾いた砂とのコントラストを作り、
        // 深い所だけ海底クワッドの色へ寄せて継ぎ目を消す。
        float depth = uSeaY - vWPos.y;                  // 海面下の深さ
        float wet = smoothstep(uSeaY+0.35, uSeaY-0.35, vWPos.y);
        diffuseColor.rgb *= mix(1.0, 0.80, wet);        // 濡れて少し暗く（乾いた砂との明暗差＝汀線が立つ）
        diffuseColor.rgb = mix(diffuseColor.rgb, vec3(0.055,0.17,0.26),
                               clamp((depth-1.6)/3.0, 0.0, 1.0) * 0.9);   // 深部は海底クワッド色へ寄せる
        diffuseColor.rgb *= mix(1.0, 0.58, clamp(depth/3.0, 0.0, 1.0));   // 深いほど減光
        // 薄いヘクス格子（陸ではごく控えめに）
        diffuseColor.rgb *= 1.0 - hexLine(vWPos.xz) * 0.10;
      `.replace(/HW_MACRO/g,(t*3).toFixed(3))).replace(`#include <roughnessmap_fragment>`,`
        float roughnessFactor = roughness;
        vec2 uvR = vWPos.xz / (${(t*3).toFixed(3)});
        roughnessFactor *= mix(texture2D(uGrassR, uvR).g, texture2D(uRockR, uvR).g, 1.0 - smoothstep(0.55,0.78, clamp(vWNrm.y,0.0,1.0)));
      `)},a}function Nu(){let t=l;return{x0:e(t.cMin,0)-60,x1:e(t.cMax,0)+60,z0:n(0,t.rMin)-60,z1:n(0,t.rMax)+60}}function Pu(){let e=Nu(),t=14e3;return{x0:e.x0-t,x1:e.x1+t,z0:e.z0-t,z1:e.z1+t}}var Fu=92;function Iu(e,t){let n=l.cx,r=l.cz,i=.04,o=e+(a(e*i,t*i,21)-.5)*22,s=t+(a(e*i+60,t*i+60,37)-.5)*22,c=Math.hypot(o-n,s-r),u=(a(e*.055,t*.055,5)-.5)*17+(a(e*.13,t*.13,9)-.5)*8+(a(e*.28,t*.28,13)-.5)*3.5;return 27-c+u}var Lu=-3,Ru=6,zu=1.7320508;function Bu(e,t){return[(.57735027*e-.33333333*t)/Ru,.66666667*t/Ru]}function Vu(e,t){let n=e,r=-e-t,i=t,a=Math.round(n),o=Math.round(r),s=Math.round(i),c=Math.abs(a-n),l=Math.abs(o-r),u=Math.abs(s-i);return c>l&&c>u?a=-o-s:l>u?o=-a-s:s=-a-o,[a,s]}function Hu(e,t){return[Ru*zu*(e+t*.5),Ru*1.5*t]}var Uu=(e,t)=>e+`,`+t,Wu=(e,t,n)=>{let r=Math.max(0,Math.min(1,(n-e)/(t-e)));return r*r*(3-2*r)},Gu=null;function Ku(){let e=l.cx,t=l.cz,n=Fu*1.2;Gu=new Map;for(let r=t-n;r<=t+n;r+=3)for(let t=e-n;t<=e+n;t+=3){let[e,n]=Vu(...Bu(t,r)),i=Uu(e,n);if(Gu.has(i))continue;let[a,o]=Hu(e,n);Gu.set(i,Iu(a,o))}}function qu(e,t){let n=Iu(e,t),r=n>0?2+2.2*(1-Math.exp(-n*.16)):2-(2-Lu)*(1-Math.exp(n/4)),[i,o]=Vu(...Bu(e,t)),s=Gu.get(Uu(i,o))??n,[c,l]=Hu(i,o),u=(1-Wu(2.6,4.7,Math.hypot(e-c,t-l)))*(1-Wu(0,1.7,Math.abs(r-2)));u>0&&(r+=((s>0?Math.max(r,2.85):Math.min(r,1.15))-r)*u);let d=1-Math.min(1,Math.abs(r-2)/1.2);return d>0&&(r+=(a(e*.13,t*.13,41)-.5+(a(e*.29,t*.29,47)-.5)*.6)*.7*d),r>2.8&&(r+=(a(e*.05,t*.05,3)-.5)*1),r}function Ju(){let e=l.cx,n=l.cz,r=Fu,i=r*2/320,a=[],o=[],s=[];for(let s=0;s<=320;s++)for(let c=0;c<=320;c++){let l=e-r+c*i,u=n-r+s*i;a.push(l,qu(l,u),u),o.push(l/t,u/t)}for(let e=0;e<320;e++)for(let t=0;t<320;t++){let n=e*321+t,r=n+1,i=n+321,a=i+1;s.push(n,i,r,r,i,a)}let c=new Cr;c.setAttribute(`position`,new dr(a,3)),c.setAttribute(`uv`,new dr(o,2)),c.setIndex(s),c.computeVertexNormals();let u=new Kr(c,Mu(!1));return u.castShadow=!0,u.receiveShadow=!0,u}function Yu(){let{x0:e,x1:t,z0:n,z1:r}=Pu(),i=new Kr(new li(t-e,r-n,1,1),new yi({color:928834,roughness:1,metalness:0}));return i.rotation.x=-Math.PI/2,i.position.set((e+t)/2,Lu-.1,(n+r)/2),i.receiveShadow=!0,i}function Xu(){let e=Fu*1.15,t=e*2,n=l.cx-e,r=l.cz-e,i=new Uint16Array(384*384);for(let e=0;e<384;e++)for(let a=0;a<384;a++){let o=n+(a+.5)/384*t,s=r+(e+.5)/384*t;i[e*384+a]=ir.toHalfFloat(qu(o,s))}let a=new Yr(i,384,384,re,D);a.minFilter=_,a.magFilter=_,a.wrapS=a.wrapT=f,a.needsUpdate=!0,yu=a,bu.set(n,r),xu=t}function Zu(){let{x0:e,x1:t,z0:n,z1:r}=Pu(),i=new li(t-e,r-n,1,1);vu=new _i({uniforms:{uTime:{value:0},uSun:{value:wu},uCam:{value:new G},uHeight:{value:yu},uBakeMin:{value:bu.clone()},uBakeSpan:{value:xu},uSeaY:{value:2},uFloorY:{value:Lu},uShoal:{value:new J(4239531)},uShallow:{value:new J(1734545)},uDeep:{value:new J(667466)},uFog:{value:new J(12900584)},uFogNear:{value:2600},uFogFar:{value:7200}},transparent:!0,depthWrite:!1,vertexShader:`varying vec3 vW; void main(){ vec4 wp=modelMatrix*vec4(position,1.0); vW=wp.xyz; gl_Position=projectionMatrix*viewMatrix*wp; }`,fragmentShader:`precision highp float;
      varying vec3 vW;
      uniform float uTime,uFogNear,uFogFar,uSeaY,uFloorY,uBakeSpan;
      uniform vec2 uBakeMin; uniform vec3 uSun,uCam,uShoal,uShallow,uDeep,uFog;
      uniform sampler2D uHeight;
      float hash(vec2 p){ return fract(sin(dot(p,vec2(41.3,289.1)))*43758.5); }
      float vnoise(vec2 p){ vec2 i=floor(p),f=fract(p); f=f*f*(3.-2.*f);
        return mix(mix(hash(i),hash(i+vec2(1,0)),f.x),mix(hash(i+vec2(0,1)),hash(i+vec2(1,1)),f.x),f.y); }
      ${ju}
      // 焼いた高さ場から海底Yを引く。範囲外は遠海＝FLOOR_Y。
      float bedY(vec2 wxz){
        vec2 uv=(wxz-uBakeMin)/uBakeSpan;
        if(uv.x<0.0||uv.x>1.0||uv.y<0.0||uv.y>1.0) return uFloorY;
        return texture2D(uHeight,uv).r;
      }
      void main(){
        float bed = bedY(vW.xz);
        float depth = max(uSeaY - bed, 0.0);              // 水深（この地点の水柱の高さ）
        // さざ波の法線（控えめ）
        float w1 = sin(vW.x*0.06 + uTime*1.2) + sin(vW.z*0.052 - uTime*1.0);
        float w2 = sin((vW.x+vW.z)*0.035 + uTime*0.7);
        float rip = vnoise(vW.xz*0.35 + uTime*0.25)-0.5;
        vec3 n = normalize(vec3(w1*0.03 + rip*0.025, 1.0, w2*0.03 + rip*0.025));
        vec3 vv = normalize(uCam - vW);
        float fres = pow(1.0 - max(dot(vv,n),0.0), 4.0);
        vec3 hh = normalize(uSun + vv);
        float spec = pow(max(dot(n,hh),0.0), 320.0);
        // 3段の水色（ヘクスの離散水深に対応）: 浅瀬~0.9 / 浅海~1.7 / 海洋>=2.6
        float tA = smoothstep(0.9, 1.6, depth);           // 浅瀬→浅海
        float tB = smoothstep(1.7, 2.7, depth);           // 浅海→海洋
        vec3 col = mix(uShoal, uShallow, tA);
        col = mix(col, uDeep, tB);
        // 水面の映り込み + 太陽ハイライト（浅瀬を白飛び・ネオン発光させないよう控えめ）
        col += vec3(0.5,0.62,0.74) * fres * 0.11;
        col += vec3(1.0,0.96,0.86) * spec * (0.05 + 0.55 * fres);
        // 汀線フォーム: 水際のごく浅い帯だけ白く、連続した海岸線として走らせる（可読性の要）
        float fband = smoothstep(0.16, 0.34, depth) * (1.0 - smoothstep(0.5, 1.05, depth));
        float fn = vnoise(vW.xz*0.6 - uTime*0.4)*0.5 + vnoise(vW.xz*1.5 + uTime*0.5)*0.5;
        float foam = fband * (0.45 + 0.55 * smoothstep(0.3, 0.85, fn));
        col = mix(col, vec3(0.95,0.98,1.0), foam*0.6);
        // 薄いヘクス格子（海では少し濃く＝海マスを数えられる）
        col *= 1.0 - hexLine(vW.xz) * 0.16;
        // 大気遠近（遠海を空へ溶かす）
        float fogF = smoothstep(uFogNear, uFogFar, length(uCam - vW));
        col = mix(col, uFog, fogF);
        // 透明度: 浅瀬は透けて砂が見える、深いほど不透明（浅海・海洋は平らな色面）。フォームは不透明寄り。
        float alpha = mix(0.5, 0.98, smoothstep(0.7, 2.0, depth));
        alpha = max(alpha, foam*0.9);
        gl_FragColor = vec4(col, alpha);
      }`});let a=new Kr(i,vu);return a.rotation.x=-Math.PI/2,a.position.set((e+t)/2,1.8,(n+r)/2),a.renderOrder=1,a}function Qu(){!gu||!fu||_u||(Ku(),fu.add(Yu()),fu.add(Ju()),Xu(),Su=Zu(),fu.add(Su),sd=fd(),fu.add(sd),_u=!0)}function $u(e,t){if(Cu&&Cu.width===e&&Cu.height===t)return;Cu?.dispose();let n=new ai(e,t);n.type=T,Cu=new Lt(e,t,{depthTexture:n,depthBuffer:!0,minFilter:_,magFilter:_})}var ed=!1;function td(e){if(!(!gu||ed||!du||!fu||!pu||!mu))try{_u||Qu();let t=du.domElement,n=t.width,r=t.height,{d:i,eye:a,center:o}=s();pu.fov=c*180/Math.PI,pu.aspect=n/r,pu.near=Math.max(2,i*.03),pu.far=i*10+12e3,pu.position.set(a[0],a[1],a[2]),pu.up.set(0,1,0),pu.lookAt(o[0],o[1],o[2]),pu.updateProjectionMatrix(),pu.updateMatrixWorld(),hu&&hu.target.position.set(l.cx,0,l.cz),vu&&(vu.uniforms.uTime.value=e*.001,vu.uniforms.uCam.value.set(a[0],a[1],a[2])),mu.render()}catch(e){ed=!0,console.warn(`showcase draw failed`,e)}}function nd(e,t){!gu||!du||!mu||(du.setSize(e,t,!1),mu.setSize(e,t),$u(e,t))}var rd=new Nr;function id(e,t,n,r){if(!gu||!Gu||!pu)return null;let i=new G(e/n*2-1,-(t/r*2-1),.5).unproject(pu);rd.origin.copy(pu.position),rd.direction.copy(i.sub(pu.position).normalize());let a=rd.origin,o=rd.direction;if(o.y>-.001)return null;let s=(5-a.y)/o.y,c=(Lu-a.y)/o.y;for(let e=Math.max(0,s);e<=c;e+=1){let t=a.x+o.x*e,n=a.y+o.y*e,r=a.z+o.z*e;if(n<=qu(t,r))return Vu(...Bu(t,r))}return null}function ad(e,t){let[n,r]=Hu(e,t),i=Gu.get(Uu(e,t))??Iu(n,r);if(i>0)return{title:`草原`,sub:`平地`,q:e,r:t};let a=(2-Lu)*(1-Math.exp(i/4));return a<1.2?{title:`浅瀬`,sub:`砂洲・底が透ける`,q:e,r:t}:a<2.2?{title:`浅海`,sub:`大陸棚`,q:e,r:t}:{title:`海洋`,sub:`深い外洋`,q:e,r:t}}function od(e,t,n,r){let i=id(e,t,n,r);return i?ad(i[0],i[1]):null}var sd=null,cd=null,ld=null,ud=null,dd=16765514;function fd(){let e=new hn,t=new Cr;t.setAttribute(`position`,new cr(new Float32Array(36),3));let n=[];for(let e=0;e<6;e++){let t=e,r=(e+1)%6,i=6+(e+1)%6,a=6+e;n.push(t,r,i,t,i,a)}t.setIndex(n),cd=new Kr(t,new Pr({color:dd,transparent:!0,opacity:.98,depthTest:!1,depthWrite:!1,side:2})),cd.renderOrder=5;let r=new Cr;return r.setAttribute(`position`,new cr(new Float32Array(21),3)),r.setIndex([0,1,2,0,2,3,0,3,4,0,4,5,0,5,6,0,6,1]),ld=new Kr(r,new Pr({color:dd,transparent:!0,opacity:.16,depthTest:!1,depthWrite:!1,side:2})),ld.renderOrder=4,e.add(ld),e.add(cd),e.visible=!1,e}function pd(){if(!sd||!cd||!ld)return;if(!ud){sd.visible=!1;return}let[e,t]=ud,[n,r]=Hu(e,t),i=cd.geometry.getAttribute(`position`),a=ld.geometry.getAttribute(`position`),o=(e,t)=>Math.max(qu(e,t),2)+.3,s=Ru*.98,c=Ru*.78;a.setXYZ(0,n,o(n,r),r);for(let e=0;e<6;e++){let t=(30+60*e)*Math.PI/180,l=Math.cos(t),u=Math.sin(t),d=n+s*l,f=r+s*u,p=n+c*l,m=r+c*u;i.setXYZ(e,d,o(d,f),f),i.setXYZ(6+e,p,o(p,m),m),a.setXYZ(e+1,p,o(p,m),m)}i.needsUpdate=!0,a.needsUpdate=!0,sd.visible=!0}function md(e,t,n,r){let i=id(e,t,n,r);return i?(ud=i,pd(),ad(i[0],i[1])):null}var hd=e=>document.getElementById(e),gd=hd(`cvshow`),_d=hd(`cv3hidden`),vd=hd(`cvmhidden`),yd=hd(`glfail`),bd=hd(`tip`),xd=hd(`stage`);function Sd(){let e=xd.clientWidth*devicePixelRatio|0,t=xd.clientHeight*devicePixelRatio|0;for(let n of[gd,_d,vd])n.width=e,n.height=t;nd(e,t)}function Cd(){u.x=l.cx,u.y=l.cz,u.z=Math.min(gd.width/156,gd.height/156)*.9,u.min=u.z*.35,u.max=u.z*3.5,o.tilt3d=50*Math.PI/180,o.mode=`showcase`}function wd(e){td(e),requestAnimationFrame(wd)}var Td=!1,Ed=0,Dd=0,Od=0,kd=!1;gd.addEventListener(`mousedown`,e=>{Td=!0,kd=!1,Od=e.button,Ed=e.clientX,Dd=e.clientY,e.preventDefault()}),gd.addEventListener(`contextmenu`,e=>e.preventDefault()),addEventListener(`mouseup`,()=>{Td=!1}),addEventListener(`mousemove`,e=>{if(!Td)return;let t=e.clientX-Ed,n=e.clientY-Dd;if(Ed=e.clientX,Dd=e.clientY,Math.abs(t)+Math.abs(n)>2&&(kd=!0),Od===2||e.shiftKey)o.tilt3d=Math.max(20*Math.PI/180,Math.min(80*Math.PI/180,o.tilt3d+n*.005));else{let e=2*s().d*Math.tan(c/2)/gd.height*devicePixelRatio;u.x-=t*e,u.y-=n*e/Math.sin(o.tilt3d)}}),gd.addEventListener(`wheel`,e=>{e.preventDefault(),u.z=Math.max(u.min,Math.min(u.max,u.z*Math.exp(-e.deltaY*.0013)))},{passive:!1}),gd.addEventListener(`mousemove`,e=>{if(Td){bd.style.display=`none`;return}let t=gd.getBoundingClientRect(),n=od((e.clientX-t.left)*devicePixelRatio,(e.clientY-t.top)*devicePixelRatio,gd.width,gd.height);if(!n){bd.style.display=`none`;return}bd.innerHTML=`<b>`+n.title+`</b><br><span class="t2">`+n.sub+`</span>`,bd.style.display=`block`,bd.style.left=Math.min(innerWidth-260,e.clientX+14)+`px`,bd.style.top=Math.min(innerHeight-80,e.clientY+14)+`px`}),gd.addEventListener(`mouseleave`,()=>{bd.style.display=`none`}),gd.addEventListener(`click`,e=>{if(kd)return;let t=gd.getBoundingClientRect(),n=md((e.clientX-t.left)*devicePixelRatio,(e.clientY-t.top)*devicePixelRatio,gd.width,gd.height);n&&(bd.innerHTML=`<b>`+n.title+`</b> <span class="t2">(`+n.q+`,`+n.r+`)</span><br><span class="t2">`+n.sub+` ／ 選択中</span>`,bd.style.display=`block`,bd.style.left=Math.min(innerWidth-260,e.clientX+14)+`px`,bd.style.top=Math.min(innerHeight-80,e.clientY+14)+`px`)}),addEventListener(`resize`,Sd);function Ad(){if(r(),i(_d,vd,yd),ku(gd,yd),!Eu()){yd.style.display=`flex`,hd(`boot`).style.display=`none`;return}Sd(),Cd(),wd(performance.now()),hd(`boot`).style.display=`none`}setTimeout(Ad,20);